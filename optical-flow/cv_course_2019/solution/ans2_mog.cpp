...
int main()
{
	...
	/// PART 2-2 ///
	// Ptr<BackgroundSubtractor> bg_model = bgsegm::createBackgroundSubtractorMOG(200, 2, 1, 0);
	// Ptr<BackgroundSubtractor> bg_model = bgsegm::createBackgroundSubtractorMOG(200, 3, 0.3, 0);
