...
##### output
    ...
    if j==take:
        cv2.imwrite('optf_farneback_surf.jpg', draw_flow(gray, flow))
    ### background
    ...
    if j==take:
        cv2.imwrite('dif_farneback_surf.jpg', draw_flow(backgraound, flow))
    ### moving parts
    ...
    if j==take:
        cv2.imwrite('moving_farneback_surf.jpg', draw_flow(dif, flow))
