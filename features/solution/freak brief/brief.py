...
#
# detector1 = cv2.xfeatures2d.StarDetector_create()
# kp_image1 = detector1.detect(img, None)
...
while True:
    ...
    # kp_gframe1 = detector1.detect(gframe , None)
    ...
    if len(goods) > 5:
        ...
        #matrix, mask = cv2.findHomography(q, t, cv2.LMEDS)
